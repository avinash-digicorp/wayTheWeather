...
import {ANIMATED_ICONS} from 'assets/animated-icons/index'

export interface IProps extends AnimatedLottieViewProps {
  /**
   * Name of Animate icon.
   */
  name?: keyof typeof ANIMATED_ICONS

  /**
   * An array of objects with color and key of each layers .
   */
  colorFilters?: Array<any>
